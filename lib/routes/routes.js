...
Router.route('/automation/macros', function() {
  this.render('macros',{data: {noRendered:true}});
});

Router.route('/automation/schedule', function() {
  this.render('macrosscheduler',{data: {noRendered:true}});
});

Router.route('/automation/conditioned', function() {
  this.render('macrosconditioned',{data: {noRendered:true}});
});

Router.route('/automation/', function() {
  this.render('automenu',{data: {noRendered:true}});
});
